...
export function DashboardPage({players,playerPhotos,sessions,settings,teamPlans,setPage,openPlayer,openEmail,openSchedule,assignedTeams,isAdmin,finances,financeSettings,financeReady,playerStars,trialsMode}:Props){
