...
export const initialPlayers: Player[] = [
  ...
  {id:'2',name:'Jamie Patel',email:'jamie@example.com',appliedTeam:'Ravens',position:'Outside',trialDate:'11 Aug 2026',attended:true,decision:'Offer planned',offeredTeam:'Ravens',offeredPosition:'Outside',notes:'Strong passer.',...assessmentDefaults(),offers:[{team:'Ravens',position:'Outside',squadRole:'Frequent player'}]},
  {id:'3',name:'Sam Taylor',email:'sam@example.com',appliedTeam:'Cobras',position:'Libero',trialDate:'18 Aug 2026',attended:true,decision:'Alternative offer',offeredTeam:'Meerkats',offeredPosition:'Libero',notes:'Better fit for Meerkats.',...assessmentDefaults(),offers:[{team:'Meerkats',position:'Libero',squadRole:'Rotational player'}]},
